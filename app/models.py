...
class LessonPlan(db.Model):
	...
	shortcode = db.Column(db.String(8)) #i.e. Lesson 5 on Week 3 is 03-05
	...
	activity1 = db.Column(db.String(500), default = "Start and overview today's schedule")
	activity2 = db.Column(db.String(500))
	activity3 = db.Column(db.String(500))
	activity4 = db.Column(db.String(500))
	activity5 = db.Column(db.String(500))
	activity6 = db.Column(db.String(500))
	activity7 = db.Column(db.String(500))
	activity8 = db.Column(db.String(500))
	activity9 = db.Column(db.String(500))
	activity10 = db.Column(db.String(500), default = "Closeout exercise and recap needs for tomorrow")
